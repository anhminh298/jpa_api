                ...
                <div class="card shadow border-0 rounded-4">
                    <div class="card-body p-4 p-md-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted small">Sử dụng phiên làm việc (Session)</p>
                        </div>
                        ...
                        <form action="${pageContext.request.contextPath}/login-session" method="post" 
                            ...
                            <hr class="my-4">
                            <div class="text-center">
                                <a href="${pageContext.request.contextPath}/login-cookie" class="btn btn-outline-secondary btn-sm">
                                    <i class="bi bi-cookie me-1"></i>Chuyển sang đăng nhập với Cookie
                                </a>
                            </div>
                        </form>
                    </div>
